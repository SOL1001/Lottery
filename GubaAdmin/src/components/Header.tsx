...
const Header: React.FC<HeaderProps> = ({ title, onMenuClick }) => {
  ...
  return (
    <header
      className="bg-white shadow-sm p-4 flex justify-between items-center  top-0 left-[259px] right-0 z-10 border-b border-gray-100"
      ...
      <div className="flex items-center gap-2 mr-2">
        ...
        <Tooltip title="Notifications" arrow>
          ...
          >
            ...
            >
              <NotificationsIcon sx={{ fontSize: 26, zIndex: 1 }} />
            </Badge>
          </IconButton>
        </Tooltip>
